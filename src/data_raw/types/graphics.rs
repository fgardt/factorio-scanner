...
use crate::data_raw::prototypes::EntityRenderOpts;
...
impl<'a> From<&'a EntityRenderOpts<'a>> for SimpleGraphicsRenderOpts {
    fn from(opts: &'a EntityRenderOpts<'a>) -> Self {
        Self {
...
impl<'a> From<&'a EntityRenderOpts<'a>> for RotatedSpriteRenderOpts {
    fn from(value: &'a EntityRenderOpts) -> Self {
        Self {
...
impl<'a> From<&'a EntityRenderOpts<'a>> for SpriteNWayRenderOpts {
    fn from(opts: &'a EntityRenderOpts<'a>) -> Self {
        Self {
...
impl<'a> From<&'a EntityRenderOpts<'a>> for SpriteVariationsRenderOpts {
    fn from(opts: &'a EntityRenderOpts) -> Self {
        Self {
            variation: 0,
            runtime_tint: opts.runtime_tint,
        }
...
impl<'a> From<&'a EntityRenderOpts<'a>> for AnimationRenderOpts {
    fn from(value: &'a EntityRenderOpts<'a>) -> Self {
        Self {
            progress: 0.0,
            runtime_tint: value.runtime_tint,
        }
...
impl<'a> From<&'a EntityRenderOpts<'a>> for Animation4WayRenderOpts {
    fn from(value: &'a EntityRenderOpts) -> Self {
        Self {
...
impl<'a> From<&'a EntityRenderOpts<'a>> for AnimationVariationsRenderOpts {
    fn from(value: &'a EntityRenderOpts) -> Self {
        Self {
            variation: 0,
            progress: 0.0,
...
impl<'a> From<&EntityRenderOpts<'a>> for RotatedAnimation4WayRenderOpts {
    fn from(value: &EntityRenderOpts<'a>) -> Self {
        Self {
            direction: value.direction.unwrap_or_default(),
            orientation: value.orientation.unwrap_or_default(),
            progress: 0.0,
